...
https://www.codewars.com/kata/rectangle-into-squares/python
...
Shell bash, PowerShell and Fortran return a string) with the size of each of the squares.
...
[lng] would be the most obvious but not in the spirit of this kata so, in that case, return None/nil/null/Nothing
